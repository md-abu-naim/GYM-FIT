...
const Login = () => {
    return (
        <div className="bg-[url('/bg.jpg')] relative h-[800px] text-white bg-cover bg-no-repeat">
            <Navber />
            <div className="flex flex-col gap-8 pr-5 lg:pr-20 md:flex-row justify-between items-center">
                <div className="w-1/2">
                    ...
                    <Image src='/register.png' className="absolute top-0 left-0 bottom-3 w-[680px]" width={400} height={400} alt="" />
                </div>
                <div className="lg:w-1/2 text-center w-full py-10">
                    ...
                    <div className="flex mb-2 items-center justify-between gap-2">
                        <button className="btn rounded-3xl mt-6 px-10 hover:bg-[#252322] bg-[#EE6C0C] border-none text-white uppercase w-1/2"> Enroll with Google</button>
                        <button className="btn rounded-3xl mt-6 px-10 hover:bg-[#252322] bg-[#EE6C0C] border-none text-white uppercase w-1/2"> Enroll with github</button>
                    </div>
